...
public final class RangeOptions {
    ...
    private RangeOptions(long limit, RevisionBound modifiedIn, RevisionBound createdIn, SortTarget sortTarget, SortDirection sortDirection) {
        this.limit = limit;
    ...
    public static final class Builder {
        ...
        public Builder sortTarget(SortTarget target)    { this.sortTarget = target; return this; }
        public Builder sortDirection(SortDirection dir) { this.sortDirection = dir; return this; }

        public RangeOptions build() {
            return new RangeOptions(limit, modifiedIn, createdIn, sortTarget, sortDirection);
        }
    }
}
