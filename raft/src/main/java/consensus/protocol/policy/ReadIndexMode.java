 ...
 * </ul>
 *
 * @see consensus.protocol.read.ReadIndex
 * @see consensus.protocol.read.ReadState
 */
public enum ReadIndexMode {

    /**
     * Heartbeat-based confirmation: broadcast a
     * {@link consensus.message.Message.Heartbeat} immediately when a
     ...
     * {@link consensus.message.Message.Heartbeat} instead of sending
     * one immediately.
     *
     * <ul>
